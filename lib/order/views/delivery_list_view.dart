...
//   @override
//   DeliveryListViewState createState() => DeliveryListViewState();
// }

// class DeliveryListViewState extends State<DeliveryListView> {
//   final DeliveryController controller = DeliveryController();
//   List<Delivery> deliveries = [];
//   double progress = 0.65;

//   List<String> title = const ['OrderId', 'Address', 'Status', 'DeliveredAt'];
//   List<dynamic> data = [];
//   List<dynamic> pc = [];
//   @override
//   void initState() {
...
//   @override
//   Widget build(BuildContext context) {
//   var map=deliveries.asMap();
//  var k= map.keys.toList(); 

//   data.add(deliveries.map((v)=>
//     v.address
//   ));
//    pc.add(
//         productCard(
...
//                               label: Text('Update'),
//                               icon: Icon(Icons.edit, color: Colors.blue),
//                               onPressed: () => _updateDelivery(data.first)),
//                           TextButton.icon(
//                             label: Text('Delete'),
//                             icon: Icon(Icons.delete, color: Colors.red),
//                             onPressed: () =>
//                                 _deleteDelivery(data.first.id as String),
//                             style: ButtonStyle(
